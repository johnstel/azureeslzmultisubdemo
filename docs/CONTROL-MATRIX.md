...
| REQ-ID-04 | Replace permanent subscription Owner with eligible, time-bound, PIM-compatible privileged access. | subscription | entra-pim | PIM-ready eligible role assignment inputs (Microsoft.Authorization roleEligibilityScheduleRequests) (built-in: No) | `—` | — | eligible | manual-evidence |
