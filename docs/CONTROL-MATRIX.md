...
| REQ-NET-04 | Audit private-link/private-endpoint readiness for storage accounts. | workload and critical-infrastructure branches | azure-policy | Demo - selected PaaS public access audit plus Storage private-link audit (built-in: No) | `${namePrefix}-audit-paas-public-network + 6edd7eda-6dd8-40f7-810d-67160c639cd9` | 2.0.0 | AuditIfNotExists, Disabled | audit-only |
| REQ-NET-05 | Audit private-link/private-endpoint readiness for Key Vault. | workload and critical-infrastructure branches | azure-policy | Demo - selected PaaS public access audit plus Key Vault private-link audit (built-in: No) | `${namePrefix}-audit-paas-public-network + a6abeaec-4d90-4a02-805f-6b26c4d3fbe9` | 1.2.1 | Audit, Disabled | audit-only |
