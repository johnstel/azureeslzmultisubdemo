...
param enableNercCipTechnicalOverlay = false
param nercCipApprovedLocations = []
param nercCipDataClassificationTagValue = ''
param nercCipSspIdTagValue = ''
param nercCipVaultDoubleEncryptionRequired = true
param nercCipVaultCheckAlwaysOnSoftDeleteOnly = true
param activityLogExportPolicyEffect = 'Disabled'
param activityLogExportLogsEnabled = 'True'
param resourceDiagnosticsPolicyEffect = 'Disabled'
