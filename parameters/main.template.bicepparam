...
param subscriptionPrivilegedAccessGroupObjectId = 'REPLACE_WITH_SUBSCRIPTION_PRIVILEGED_ACCESS_GROUP_OBJECT_GUID'
...
param deployEligibleOwnerRoleAssignments = false
param eligibleOwnerAssignmentStartDateTime = 'REPLACE_WITH_ELIGIBLE_OWNER_START_DATE_TIME_UTC'
param eligibleOwnerAssignmentDuration = 'P90D'
param eligibleOwnerAssignmentJustification = 'REPLACE_WITH_ELIGIBLE_OWNER_ASSIGNMENT_JUSTIFICATION'
