...
module userAssigned '../../modules/remediating-policy-assignment.bicep' = {
  ...
  params: {
    ...
    userAssignedIdentityResourceId: '/subscriptions/44444444-4444-4444-4444-444444444444/resourceGroups/identities/providers/Microsoft.ManagedIdentity/userAssignedIdentities/policy-remediation'
    userAssignedIdentityPrincipalId: '55555555-5555-5555-5555-555555555555'
    verifiedRoleDefinitionIds: [
