...
for scenario in wrong-active-subscription wrong-subscription-tenant disabled-subscription wrong-ancestry replacement-missing replacement-assignment-missing replacement-link-wrong wrong-link assignment-read-error definition-read-error; do
