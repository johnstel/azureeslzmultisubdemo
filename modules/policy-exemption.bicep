...
func isCanonicalDate(value string) bool => length(value) == 10 && substring(value, 4, 1) == '-' && substring(value, 7, 1) == '-' && empty(stripDigits(substring(value, 0, 4))) && empty(stripDigits(substring(value, 5, 2))) && empty(stripDigits(substring(value, 8, 2)))
  ? int(substring(value, 0, 4)) >= 1 && int(substring(value, 5, 2)) >= 1 && int(substring(value, 5, 2)) <= 12 && int(substring(value, 8, 2)) >= 1 && int(substring(value, 8, 2)) <= (int(substring(value, 5, 2)) == 2 ? (isLeapYear(int(substring(value, 0, 4))) ? 29 : 28) : (contains([4, 6, 9, 11], int(substring(value, 5, 2))) ? 30 : 31))
  : false
